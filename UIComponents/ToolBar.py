...
from ToolBar.File.ImportTitleUpdate import TitleUpdate
from ToolBar.File.OpenSquadFilesPath import OpenSquadFilesPath 
from ToolBar.File.OpenGameFolder import OpenGameFolder
from ToolBar.Tools.ClearEA_AppCache import delete_cache_files
from ToolBar.Tools.RepairGame.Steam import SteamWindow
from ToolBar.Tools.RepairGame.EAApp import EAAppWindow
from ToolBar.Tools.RepairGame.EpicGames import EpicGamesWindow
from ToolBar.Help.InformationWindow import InformationWindow
from ToolBar.Help.ChangelogWindow import ChangelogWindow
...
class ToolBar:
    ICONS = {
        "clear_cache": "Assets/Icons/ic_fluent_broom_24_filled.png",
        "repair_game": "Assets/Icons/ic_fluent_wrench_24_filled.png",
        "exit": "Assets/Icons/ic_fluent_pane_close_24_filled.png",
        "steam": "Assets/Icons/Steam.png",
        "ea_app": "Assets/Icons/EA_Desktop.png",
        "epic_games": "Assets/Icons/EpicGames.png",
        "info": "Assets/Icons/ic_fluent_info_24_filled.png",
        "arrow_import": "Assets/Icons/ic_fluent_arrow_import_24_filled.png",
        "folder_zip": "Assets/Icons/ic_fluent_folder_zip_24_filled.png",
        "from_folder": "Assets/Icons/ic_fluent_folder_24_filled.png",
        "open_folder": "Assets/Icons/ic_fluent_open_folder_24_regular.png",
        "refresh_table": "Assets/Icons/ic_fluent_arrow_sync_24_filled.png",
        "restart_app": "Assets/Icons/ic_fluent_arrow_counterclockwise_dashes_24_filled.png",
        "code": "Assets/Icons/ic_fluent_code_24_filled",

    }

    def __init__(self, parent=None):
        self.parent = parent
        self.ToolBarContainer = None
    ...
    def create_tool_bar(self):
        try:
            self.ToolBarContainer = QWidget(self.parent)
            self.ToolBarContainer.setStyleSheet("background-color: rgba(10, 10, 10, 0.03);")
            self.ToolBarContainer.setFixedHeight(26)

            self.ToolBar = QHBoxLayout(self.ToolBarContainer)
            ...
            for text, menu_callback in menus:
                self.ToolBar.addWidget(self.create_button(text, menu_callback))

            self.parent.main_layout.addWidget(self.ToolBarContainer)
    ...
    def FileMenu(self, button):
        ...
        menu.addAction(self._create_action(
            "Restart", 
            "restart_app", 
            lambda: (subprocess.Popen([executable_path] + sys.argv) if os.path.exists(executable_path := os.path.join(os.path.dirname(os.path.abspath(__file__)), "FC Rollback Tool.exe")) else subprocess.Popen([sys.executable, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "Main.py")] + sys.argv), QApplication.quit())
        ))
        # Add Exit Action
