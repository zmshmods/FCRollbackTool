...
class MenuBar:
    ICONS = {
        ...
        "compatibility": "Data/Assets/Icons/ic_fluent_comp_24_filled.png",
    ...
    def ToolsMenu(self, button):
        ...
        menu.addAction(self._create_action("Live Editor Compatibility Info", "compatibility", lambda: self.show_window(LiveEditorCompatibilityInfo)))
        menu.exec(button.mapToGlobal(QPoint(button.rect().bottomLeft().x(), button.rect().bottomLeft().y())))
