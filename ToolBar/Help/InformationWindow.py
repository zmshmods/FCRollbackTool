...
class InformationWindow(AcrylicWindow):
    ...
    def create_title_bar(self):
        try:
            ...
            icon_pixmap = QPixmap("Assets/Icons/ic_fluent_info_24_outlined.png")  # تحميل الأيقونة
            # ضبط حجم الأيقونة
        ...
        try:
            ...
            def create_link_section(title, links):
                ...
                for text, url in links:
                    ...
                    # Add the icon
                    icon_label = QLabel()
                    pixmap = QPixmap("Assets/Icons/ic_fluent_link_24_regular.png").scaled(16, 16, Qt.KeepAspectRatio, Qt.SmoothTransformation)
